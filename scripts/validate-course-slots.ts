 ...
 * point. Today: 82 courses, 328 slots, 2,296 strings.
 *
 ...
 * it in the same edit as the ratchet, or it becomes the number the next
 * reader trusts.
 */
const MIN_COURSES = 82
const MIN_STRINGS = 2296
