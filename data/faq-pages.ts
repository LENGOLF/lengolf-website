...
export const faqPages: FaqSeoPage[] = [
  ...
  // in-batch cost-to-fly entry below.
  {
    ...
    content: {
      answer_intro:
        '多くの旅行者にとって、タイでゴルフクラブをレンタルするほうが、自分のクラブを持ち込むより安く、手間もかかりません。ゴルフバッグにかかる航空会社の手数料は片道2,000〜6,000THB以上、これに大型手荷物を運ぶ煩わしさが加わります。バンコクではレンタルクラブが広く手配でき、LENGOLFならCallaway（マジェスティ）のプレミアムセットが1時間約150THB、1日約1,200THBからご利用いただけます（2026年7月現在）。',
      answer_body:
  ...
  // of Bangkok-area courses, the relaxed-course exception, spikeless favoured
  ...
  // NOT reconciled with the sibling's 400~500 tip. The EN intro (mid-range 400–500 /
  // premium resorts 500–600) agrees with its table and body (budget 300–400 /
  // mid-range 400–500 / premium 500–600), and the KO carries both verbatim.
  // The KO as-of marker (2026년 7월 기준) is attached once under the table; 기준
  // appears nowhere else (기본선, not 기준선, is used for "baseline" for exactly
  // that reason).
  // related_* retargeted to KO-translated pages — /golf-in-thailand-guide has no
  // KO translation and is replaced with /guide/round-of-golf-cost-bangkok.
  {
  ...
  // EN faq-20 and is carried verbatim: the intro says 中档 400–500 / 高端度假村
  // 500–600, and the table and body say 平价 300–400, 中档 400–500, 高端 500–600,
  // which agree with each other. These figures also differ from the sibling faq-19-zh (fee
