...
export const faqPages: FaqSeoPage[] = [
  ...
  // all four are KO-translated targets.
  {
    ...
    content: {
      answer_intro:
        '실내 골프 바는 대부분 드레스 코드가 없어요. 편하고 팔을 크게 휘두를 수 있는 옷이면 무엇이든 괜찮아요. 티셔츠, 청바지, 반바지, 운동화, 샌들 모두 문제없어요. 전통적인 골프장과 달리 실내 골프 바에서는 카라 셔츠나 골프화 같은 특정 복장을 요구하지 않아요. LENGOLF에도 퇴근길 오피스 룩부터 캐주얼한 스트리트 웨어까지 다양한 차림으로 오세요.',
      answer_body:
  ...
  // TH sibling made). No language/coach claim is added — the EN makes none.
  {
    ...
    meta_description:
      '子どもでもゴルフシミュレーターは楽しめます。5歳前後からクラブを振って遊べるようになり、画面に映る弾道と即時のスコアがゲーム感覚。LENGOLFはご家族でのご来店を歓迎し、ジュニア向けのレッスンもご用意しています。',
    featured_image: null,
    schema_markup: null,
    status: 'published',
    category: 'general',
  ...
  // related_* mirror the EN entry; all targets are JA-translated.
  {
    ...
    page_type: 'faq',
    slug: 'practice-golf-swing-without-driving-range-bangkok',
    title: 'バンコクでドライビングレンジなしにスイング練習はできる？ — シミュレーター活用法',
    meta_description:
  ...
  // 5 ชั่วโมง). NOTE — the EN source contradicts itself and BOTH halves are
  // carried verbatim: answer_intro says outdoor days "typically cost
  // 3,000-5,000 THB per person" while answer_body totals "3,000-7,000 THB".
  // Per the no-harmonization rule the TH keeps 3,000-5,000 in the intro and
  // 3,000-7,000 in the body; flag it upstream rather than silently reconciling.
  // Static content mirroring the EN entry's literal prices — this is what the
  // FAQ renderer actually serves. NOTE: the EN sibling has an (unwired)
  ...
  // guide. All related_* targets are TH-translated.
  {
    ...
    meta_description:
      'กิจกรรมกอล์ฟองค์กรในกรุงเทพฯ ที่ LENGOLF เริ่มต้น 9,999-21,999 บาท รวมเบย์กอล์ฟ เครื่องดื่ม และอาหารจัดเลี้ยงสำหรับ 10-25 คน ส่วนงานกลางแจ้งมีค่าใช้จ่ายสูงกว่ามาก (ข้อมูล ณ กรกฎาคม 2026)',
    featured_image: null,
    schema_markup: null,
    status: 'published',
    category: 'events',
  ...
  // is replaced with the ZH first-time-in-Thailand guide.
  {
    ...
    page_type: 'faq',
    slug: 'thailand-visa-guide-golf-tourists',
    title: '泰国高尔夫旅客签证指南 — 免签、落地签与电子签怎么选',
    meta_description:
  ...
  // replaced with the ZH first-time and airport-transfer guides.
  {
    ...
    content: {
      answer_intro:
        '2026年泰国对高尔夫旅客的入境要求很简单——没有疫情时期的限制，没有高尔夫专用许可，自用球杆也没有特殊的海关手续。出发前唯一必须完成的，是泰国电子入境卡（TDAC），它在2025年5月取代了旧的纸质TM6表格。',
      answer_body:
  ...
  // 1,000바트 미만, 쿨 시즌 11월~2월) and the hedges are carried (approximately →
  ...
  // body names. All related_* targets are TH-translated.
  {
    ...
    content: {
      ...
      related_questions: [
        { slug: 'how-far-in-advance-book-golf-bangkok', question: 'ควรจองกอล์ฟในกรุงเทพฯ ล่วงหน้านานแค่ไหน' },
  ...
  // translation and is replaced with the ZH /guide/round-of-golf-cost-bangkok.
  {
    ...
    content: {
      answer_intro:
        '在中档球场给球童400–500泰铢，在高端度假村球场给500–600泰铢。打完第18洞在果岭边把现金直接交给球童，而不是在专卖店柜台结算。',
      answer_body:
  ...
  // 60-80 เฮกตาร์, ranges to 21:00-22:00 น., 9/18 holes, four players per bay,
