...
export const faqPages: FaqSeoPage[] = [
  ...
  // ─── TH: how-long-does-simulator-golf-take ───
  {
    ...
    page_type: 'faq',
    slug: 'how-long-does-simulator-golf-take',
    title: 'เล่นกอล์ฟซิมมูเลเตอร์หนึ่งรอบใช้เวลานานแค่ไหน',
    meta_description:
      'การเล่นกอล์ฟซิมมูเลเตอร์ครบ 18 หลุมใช้เวลาประมาณ 1.5-2.5 ชั่วโมงสำหรับกลุ่ม 2-4 คน ส่วนผู้เล่นคนเดียวเล่นครบ 18 หลุมได้ในประมาณ 45-60 นาที',
    featured_image: null,
    schema_markup: null,
    status: 'published',
    category: 'general',
  ...
  // ประมาณ 1,200 บาท/วัน, ประมาณ 500 บาท จัดส่ง, 500-1,500 บาทต่อรอบ) and are
