...
export const faqPages: FaqSeoPage[] = [
  ...
  // replaced with /golf-club-rental.
  {
    ...
    content: {
      answer_intro:
        '在曼谷品质较好的高尔夫场馆里，最常见的租借品牌是Callaway、TaylorMade和Titleist。在LENGOLF，男士和女士高级租借套装均为Callaway；每次预订球位均免费提供标准左手球杆，如有需要，另可提供一套左手专用高级套装。平价球场通常备的是年代较久或品牌混杂的套装，成色差异也相当大。',
      answer_body:
