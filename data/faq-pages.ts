...
export const faqPages: FaqSeoPage[] = [
  {
    ...
    meta_description:
      'Yes, you can rent golf clubs in Bangkok. LENGOLF offers free standard sets with every bay booking and premium Callaway rentals from 150 THB/hour with delivery.',
    featured_image: null,
    schema_markup: null,
    status: 'published',
    category: 'rental',
  ...
  // ─── TH: can-i-rent-golf-clubs-in-bangkok ───
  {
    ...
    meta_description:
      'เช่าไม้กอล์ฟในกรุงเทพฯ ได้แน่นอน LENGOLF มีชุดไม้มาตรฐานให้ฟรีทุกการจองเบย์ และมีไม้พรีเมียม Callaway ให้เช่าเริ่มต้น 150 บาท/ชั่วโมง พร้อมบริการจัดส่ง',
    featured_image: null,
    schema_markup: null,
    status: 'published',
    category: 'rental',
  ...
  // so they are replaced with the in-batch FAQ slugs and the JA guide.
  {
    ...
    meta_description:
      'バンコクでゴルフクラブのレンタルは可能です。LENGOLFではベイのご予約ごとに標準セットが無料、Callawayのプレミアムセットは1時間150THBから、コースへの持ち出しは1日1,200THBから。市内配送にも対応しています（2026年7月現在）。',
    featured_image: null,
    schema_markup: null,
    status: 'published',
    category: 'rental',
  ...
  // they are replaced with the in-batch FAQ slugs and the KO guide.
  {
    ...
    meta_description:
      '방콕에서 골프 클럽 대여는 가능해요. LENGOLF는 베이 예약마다 기본 세트가 무료, Callaway 프리미엄 세트는 시간당 150바트부터, 코스 반출은 하루 1,200바트부터예요. 시내 당일 배송도 가능해요 (2026년 7월 기준).',
    featured_image: null,
    schema_markup: null,
    status: 'published',
    category: 'rental',
  ...
  // The Mercury Ville, Callaway). related_* retargeted to
  ...
  // the LENGOLF prices carry （2026年7月現在）. Latin brand names are glossed once
  // with katakana on first use. related_* are all JA-translated targets — the two
  ...
  // REVA). related_* are all ZH-translated targets — the batch-1
  ...
  // ─── GG-029: Are Rental Golf Clubs Good Enough for Serious Golfers? ────────
  {
    ...
    meta_description: 'At premium Bangkok venues and simulators like LENGOLF, modern name-brand rental sets are good enough for serious golfers. Here\'s how to find the best ones.',
    featured_image: null,
    schema_markup: null,
    status: 'published',
  ...
  // what-golf-clubs-available-rent-bangkok FAQ have no JA translation.
  {
    ...
    meta_description:
      'バンコクの上位コースやLENGOLFのようなシミュレーター施設なら、年式の新しい有名ブランドのレンタルセットは本格派ゴルファーにも十分。品質を左右する条件と、自分のクラブを持参すべき場面の見極め方を解説します。',
    featured_image: null,
    schema_markup: null,
    status: 'published',
    category: 'clubs-rental',
  ...
  // have no KO translation.
  {
    ...
    meta_description:
      '방콕의 상위권 코스나 LENGOLF 같은 시뮬레이터 시설이라면 현행 세대의 유명 브랜드 대여 세트는 진지한 골퍼에게도 충분해요. 품질을 가르는 조건과, 내 클럽을 가져가야 할 상황을 정리했어요.',
    featured_image: null,
    schema_markup: null,
    status: 'published',
    category: 'clubs-rental',
  ...
  // have no ZH translation.
  {
    ...
    meta_description:
      '曼谷的高端球场和LENGOLF这类模拟器场馆，现行的知名品牌租借套装足以让认真的球友放心使用。决定品质的条件与该自带球杆的时机，一次说清。',
    featured_image: null,
    schema_markup: null,
    status: 'published',
    category: 'clubs-rental',
