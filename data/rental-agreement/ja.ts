...
export const ja: RentalAgreementContent = {
  ...
  sections: [
    ...
    },
    {
      heading: '第5条（通常の摩耗）',
      paragraphs: [
        '軽微な擦り傷、グリップの摩耗、表面の跡など、一般的なゴルフのプレーによる通常の摩耗は想定されているものであり、LENGOLFが負担します。これについて借主に料金を請求することはありません。',
      ],
    },
    {
      heading: '第6条（紛失、盗難または損傷）',
      items: [
        '借主は、レンタル品が借主の管理下にある間に生じた紛失、盗難、または通常の摩耗（第5条）を超える損傷について責任を負うものとします。',
        'レンタル品が損傷した場合、借主は合理的な修理費用を支払うことに同意するものとします。いずれかの品目が紛失もしくは盗難に遭った場合、または経済的に修理が見合わない程度に損傷した場合、借主はその公正な代替価額を支払うことに同意するものとします。当社は、修理費用および公正な代替価額を個別に査定し、料金を請求する前にその内容を借主に説明します。',
        'レンタル品の紛失、盗難または損傷が生じた場合は、できる限り速やかに当社へお知らせください。',
      ],
    },
    {
      heading: '第7条（配送および引取り）',
      items: [
        '当社は、事前の取り決めに基づき、バンコクおよびその周辺地域への配送を行います。配送および返却時の引取りの日時と場所は、予約時に合意するものとします。バンコク首都圏外の場所については個別に対応しますので、当社までお問い合わせください。',
    ...
    },
    {
      heading: '第8条（返却の遅延）',
      items: [
        'レンタル品の返却期限は、合意した返却日時とします。借主がこれを超えてレンタル品を保持する場合、返却されるまでの超過した各日（端数日を含みます）について、通常の日額料金による追加のレンタル料金が発生します。',
        'レンタル品が返却されず、当社が借主と連絡を取ることができない場合、当社はレンタル品を第6条に基づく紛失として取り扱うことができます。',
      ],
    },
    {
      heading: '第9条（キャンセルおよび返金）',
      items: [
  ...
  closing: [
    '当社は、本規約を随時更新することがあります。借主が予約した時点で有効な版が、当該レンタルに適用されます。',
  ],
}
