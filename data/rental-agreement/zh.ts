...
export const zh: RentalAgreementContent = {
  ...
  intro: [
    '本协议约定LENGOLF CO., LTD.（以下简称“LENGOLF”或“我们”）向您（以下称“您”或“承租人”）出租高尔夫球杆套装及相关器材（以下统称“器材”），供您在店外的高尔夫球场使用的相关事宜。本协议适用于您向我们进行的每一笔外场（球场）租赁，无论您是通过booking.len.golf、LINE、电话、电子邮件还是现场预订。室内及店内模拟器球杆租赁不属于本协议的适用范围。',
  ...
  sections: [
    ...
    },
    {
      ...
      items: [
        ...
        '须有人于约定的时间在约定的地点等候，以便在配送时接收器材，并在归还取件时交还器材。',
    ...
    },
    {
      heading: '8. 逾期归还',
      items: [
        '器材应于约定的归还日期和时间归还。如您逾期保留器材，在器材归还之前，每超出一天（不足一天的按一天计）均按标准日租费加收租金。',
    ...
    },
    {
      ...
      items: [
        ...
        '如您未前来自取器材，或无法接收器材（未到场），该预订可被视为已取消；退款按个案处理。',
    ...
    },
    {
      ...
      items: [
        ...
        '本协议的任何内容均不限制您享有的、依据泰国法律不可被排除的任何权利。',
      ],
    },
    {
      heading: '11. 个人信息',
      paragraphs: [
        '我们将依照我们的隐私政策（len.golf/privacy-policy）处理您为完成本次租赁而提供的个人信息。',
      ],
    },
    {
      heading: '12. 适用法律与语言',
