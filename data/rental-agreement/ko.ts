...
export const ko: RentalAgreementContent = {
  ...
  lastUpdated: '최종 업데이트: 2026년 8월 7일',
  notice: {
    text: '이 한국어 번역본은 편의를 위해 제공되며, 영문본과 내용이 상충하는 경우 영문본이 우선합니다.',
    linkText: '영문본 보기',
  },
  intro: [
    '본 약관은 LENGOLF CO., LTD.(이하 "LENGOLF" 또는 "당사")가 골프장에서의 외부 사용을 위하여 귀하(이하 "귀하" 또는 "임차인")에게 골프 클럽 세트 및 관련 장비(이하 "장비")를 대여하는 것에 관하여 규정합니다. 본 약관은 booking.len.golf, LINE, 전화, 이메일 또는 직접 방문 중 어떤 방법으로 예약하든, 귀하가 당사와 진행하는 모든 외부(골프장) 대여에 적용됩니다. 실내 및 매장 내 시뮬레이터용 클럽 대여에는 본 약관이 적용되지 않습니다.',
    '당사와 골프장 대여 예약을 확정함으로써 귀하는 본 약관에 동의합니다.',
  ],
  sections: [
    {
      heading: '1. 대여',
    ...
    },
    {
      heading: '2. 요금 및 결제',
      items: [
        '대여 요금, 배송비 및 추가 품목 가격은 예약 시 표시된 금액이며, 태국 바트로 표시된 VAT 포함 가격입니다. 결제는 예약 시점에 결제 단계에서 제공되는 결제 수단 중 하나를 이용하여 온라인으로 이루어집니다. 배송 주문은 온라인 선결제가 필요하며, 픽업 주문은 픽업 시 현금 결제도 선택할 수 있습니다.',
        '보증금은 필요하지 않습니다.',
        '결제를 완료하시는 동안 예약은 최대 2시간 유지됩니다. 이 시간 내에 결제가 완료되지 않으면 예약은 자동으로 취소되며 장비 확보도 해제됩니다.',
      ],
    },
    {
      heading: '3. 인도 시 상태',
    ...
    },
    {
      heading: '9. 취소 및 환불',
      items: [
        `**대여 시작 24시간 전까지 무료 취소 가능합니다.** 대여 기간 시작 24시간 이상 전에 취소하시면 취소 수수료 없이 결제하신 금액 전액을 환불해 드립니다. 취소하시려면 LINE @lengolf, 전화(${BUSINESS_INFO.phone}) 또는 이메일(${BUSINESS_INFO.email})로 당사에 연락해 주십시오.`,
        ...
        '당사가 귀하가 예약한 장비를 제공할 수 없는 경우, 귀하는 이용 가능한 대체 장비 또는 전액 환불 중에서 선택할 수 있습니다.',
      ],
    },
    {
      ...
      items: [
        ...
        '장비는 여가 목적의 골프용으로 "있는 그대로"의 조건으로 제공됩니다. 법률이 허용하는 범위 내에서, LENGOLF는 귀하의 장비 사용으로 인해 발생하는 어떠한 부상, 손실 또는 손해에 대해서도, 그리고 어떠한 간접적 손실 또는 결과적 손실에 대해서도 책임을 지지 않습니다.',
    ...
    },
    {
      heading: '14. 동의',
      paragraphs: [
        '온라인, LINE, 전화, 이메일 또는 직접 방문 등 어떠한 방법으로든 LENGOLF와 골프장 대여 예약을 확정함으로써, 귀하는 본 약관을 읽고 이해하였으며 이에 동의함을 확인합니다.',
      ],
    },
  ],
  closing: [
