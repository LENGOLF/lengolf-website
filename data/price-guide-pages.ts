...
export const priceGuidePages: PriceGuideSeoPage[] = [
  ...
  // BTS Chidlom kept Latin per brand_immutable.
  {
    ...
    content: {
      ...
      comparison_with_alternatives:
        'ส่วนต่างของค่าใช้จ่ายระหว่างกอล์ฟในร่มกับกอล์ฟกลางแจ้งในกรุงเทพฯ นั้นชัดเจนมาก การออกรอบที่สนามระดับกลางมีค่าใช้จ่ายประมาณ 2,500 บาท (ค่ากรีนฟี) บวก 400 บาท (ค่าแคดดี้) บวก 700 บาท (รถกอล์ฟ) บวก 1,500 บาท (ค่าเช่าไม้กอล์ฟหากจำเป็น) รวมเป็นอย่างน้อย 5,100 บาทต่อคน และยังต้องใช้เวลาเดินทาง 1-2 ชั่วโมงต่อเที่ยว ส่วนที่ LENGOLF กลุ่ม 5 คนเล่นได้ในราคารวม 550 บาทต่อชั่วโมง หรือ 110 บาทต่อคน ในห้องปรับอากาศที่ BTS ชิดลม สำหรับการซ้อม การมาสังสรรค์กับเพื่อน หรือใครก็ตามที่อยากลองเล่นกอล์ฟโดยไม่ต้องทุ่มเวลาทั้งวัน กอล์ฟซิมูเลเตอร์ในร่มเข้าถึงได้ง่ายกว่าอย่างเทียบกันไม่ติด',
      value_proposition:
        'ที่ 110 บาทต่อคนต่อชั่วโมง (กลุ่ม 5 คน) LENGOLF คือวิธีเล่นกอล์ฟที่คุ้มค่าที่สุดในกรุงเทพฯ ไม่มีค่าแคดดี้ ไม่มีค่าเดินทาง ไม่มีกฎการแต่งกาย แค่มาที่ BTS ชิดลม แล้วเล่นได้เลย',
      last_verified: '2026-02-19',
      venue_comparison: {
        venues: [
          {
            name: 'LENGOLF',
            location: 'Mercury Ville, BTS ชิดลม',
            tech: 'Bravo',
            players_per_bay: 5,
  ...
  // four EN targets are KO-translated after this batch.
  {
    ...
    content: {
      ...
      venue_comparison: {
        ...
        summary:
          '방콕 도심의 시뮬레이터 매장 중에서 LENGOLF의 1인당 비용이 가장 낮아요. 5명이 한산한 시간대에 이용하면 1인당 시간당 110바트로, 드라이빙 레인지 볼 한 바구니보다도 저렴해요. Topgolf는 표시 요금만 보면 경쟁력이 있어 보이지만 서비스 차지와 VAT(약 17%)가 빠져 있고, 매장도 방콕 도심에서 30~45분 거리예요. Fairway Golf & City Club은 프리미엄 Trackman 장비를 쓰지만 기본 요금이 거의 두 배예요. Front 9은 요금대가 LENGOLF와 가장 가깝지만 베이당 4명까지만 이용할 수 있어요.',
      },
      sections: [
        {
  ...
  // — all four EN targets are ZH-translated.
  {
    ...
    content: {
      ...
      price_breakdown: [
        ...
        { item: '高尔夫课程（室内）', price: '1,800泰铢/小时', notes: '教练一对一。LENGOLF提供1小时免费体验课。' },
      ...
      sections: [
        ...
        },
        {
          ...
          body: '室内高尔夫模拟器让你在空调房里打Pebble Beach、St Andrews、TPC Sawgrass这些世界名球场。现在的模拟器对球速、发射角、旋转和飞行距离的追踪都相当准确。在LENGOLF，每个球位最多可容纳5人，收费是按球位算的，不是按人头。4个朋友在平日上午打2小时，总共1,100泰铢，一人275泰铢。标准球杆免费租借已包含在内，所以你不用自带装备，也不必另外去租。',
        },
        {
          heading: '哪一种更适合你',
          body: '如果你想要完整的高尔夫体验——新鲜空气、修剪整齐的球道，加上4–5小时的步行或乘车——那就选室外球场。如果你看重的是方便（就在曼谷市中心，不用跑远）、便宜（只是室外的一个零头）、灵活（打1小时还是4小时都行），以及一天里任何时段都不受天气影响，那就选室内模拟器。对新手、游客和朋友聚会来说，室内模拟器通常更划算。',
        },
      ],
      curated_reviews: [
        {
    ...
    content: {
      ...
      venue_comparison: {
        venues: [
          ...
          },
          {
            ...
            peak_rate: '미공개',
            price_includes_tax: null,
            notes: '사톤에 새로 생긴 골프 앤드 바. 예약 앱에서 오전 한산한 시간대가 시간당 1,000바트 안팎으로 나오고, 전체 요금표는 공개돼 있지 않아요. 7:00~22:00 영업.',
          },
          {
            name: 'Golfzon Bangna',
      ...
      sections: [
        ...
        },
        {
          ...
          body: 'Groove & Grit Golf and Bar는 MRT Lumphini 근처 Supalai Icon Sathorn에 문을 연, 방콕 도심에서 가장 새로운 시뮬레이터 겸 바 콘셉트예요. 성격으로 보면 LENGOLF와 가장 비슷하고, 다만 사톤 쪽에 있어요. 베이에는 Foresight Falcon 발사 모니터와 Swing Catalyst, 고속 카메라가 들어가 있고, 와인과 프리미엄 주류 라운지, PGA 프로 레슨도 운영해요. 예약 플랫폼에는 오전 한산한 시간대가 시간당 1,000바트 안팎으로 올라오지만 전체 요금표는 공개하지 않아서, 피크 요금은 직접 문의하셔야 해요. 매일 7:00~22:00 영업해요.',
        },
        {
  ...
  // related_slugs unchanged — all five are JA-translated.
  {
    ...
    content: {
      ...
      price_breakdown: [
        ...
        { item: '無料体験レッスン', price: '0THB', notes: 'プロと1時間。その後のお申し込みは自由です。LINEまたはウェブサイトからご予約ください。' },
  ...
  // /golf-club-rental and the sibling /cost page are all KO-translated.
  {
    ...
    content: {
      intro:
        'LENGOLF 베이 대여는 최대 5명까지 시간당 550바트부터, 1인당 110바트예요. 월 패키지와 골프 레슨, 이벤트 패키지, 프리미엄 클럽 대여도 준비돼 있어요. 아래가 2026년 전체 요금이에요 (2026년 2월 기준).',
      price_breakdown: [
  ...
  // EN targets are ZH-translated.
  {
    ...
    content: {
      ...
      price_breakdown: [
        ...
        { item: '免费体验课', price: '0泰铢', notes: '与教练上1小时，无任何附带条件。可通过LINE或网站预约。' },
      ...
      value_proposition:
        'LENGOLF想做的就是让高尔夫变得人人可及。5人一组、平日上午来打，每人110泰铢，比一张电影票还便宜。标准球杆免费，意味着你两手空空走进来就能打。再加上1小时免费体验课，试一试完全没有风险。',
      last_verified: '2026-02-19',
      sections: [
        {
          heading: '哪个套餐最划算',
  ...
  // Phone is 096-668-2335 — BUSINESS_INFO.phone, and what this page's own
  // CTA button renders. The EN entry previously carried an orphan
  // 02-658-6633 that appeared nowhere else in the repo; corrected in EN
  // and synced to every locale.
  // disagrees with BUSINESS_INFO.phone rendered by the same page's CTA).
  {
    ...
    content: {
      ...
      price_breakdown: [
        { item: 'แพ็กเกจขนาดเล็กของ LENGOLF (10-15 คน)', price: '9,999 บาทเหมารวม', notes: '2 เบย์ 3 ชั่วโมง รวมเบียร์ 10 ขวด ค็อกเทล 5 แก้ว น้ำอัดลมไม่จำกัด และอาหารจาก Smith & Co.' },
        { item: 'แพ็กเกจขนาดกลางของ LENGOLF (15-25 คน)', price: '21,999 บาทเหมารวม', notes: '4 เบย์ (เหมาทั้งร้าน) 3 ชั่วโมง รวมเบียร์ 20 ขวด ค็อกเทล 10 แก้ว น้ำอัดลมไม่จำกัด และอาหารจาก Smith & Co. และ Pizza Mania' },
      ...
      comparison_with_alternatives:
        'การจัดกิจกรรมกอล์ฟบริษัทกลางแจ้งสำหรับ 20 คน โดยทั่วไปมีค่าใช้จ่าย 80,000-150,000 บาท เมื่อรวมค่ากรีนฟี (40,000-80,000 บาท) ค่าแคดดี้ (8,000 บาท) ค่าเดินทาง (10,000-15,000 บาท สำหรับรถตู้เหมา) อาหารกลางวัน (15,000-25,000 บาท) และของรางวัล อีกทั้งยังใช้เวลา 6-8 ชั่วโมงรวมการเดินทาง ส่วนที่ LENGOLF แพ็กเกจขนาดกลางที่ 21,999 บาท ครอบคลุมทุกอย่างสำหรับผู้ร่วมงานสูงสุด 25 คน ในรูปแบบ 3 ชั่วโมง ที่ BTS ชิดลม พอดี นั่นคือประหยัดกว่าราว 85 เปอร์เซ็นต์ และใช้เวลาเพียงครึ่งเดียว',
      value_proposition:
  ...
  // guide, the closest in-locale equivalent. The other four are unchanged.
  {
    ...
    content: {
      ...
      price_breakdown: [
        ...
        { item: '屋外コース — 1人あたり（割安なコース）', price: '3,000〜4,000THB', notes: 'グリーンフィー、キャディー、カート込み。食事と移動は別途。' },
  ...
  // KO-translated guide on the same topic (the closest in-locale equivalent).
  {
    ...
    content: {
      intro:
        '방콕에서 기업 골프 행사를 열면 비용은 LENGOLF 올인클루시브 9,999바트(10~15명)부터 실외 코스 아웃팅 100,000바트 이상까지예요. LENGOLF에서는 음식과 음료, 3시간 골프까지 포함해 1인당 667~1,000바트로, 실외 행사에 드는 비용의 일부 수준이에요 (2026년 2월 기준).',
      price_breakdown: [
      ...
      sections: [
        ...
        {
          heading: '기업 행사 예약 방법',
          body: 'LINE(@lengolf)이나 전화 096-668-2335로 연락 주시면 행사 내용을 함께 상의해 드려요. 중규모 패키지(전관)는 최소 2주 전 예약을 권해 드리고, 소규모 패키지는 며칠 전에도 준비되는 경우가 많아요. 25명이 넘거나 특별한 요청이 있으시면 맞춤 패키지도 가능해요.',
        },
      ],
      curated_reviews: [
        {
  ...
  // guide /guide/corporate-golf-events-bangkok, the nearest in-locale equivalent.
  {
    ...
    content: {
      intro:
        '在曼谷办一场企业高尔夫活动，费用从9,999泰铢（LENGOLF全包套餐，10–15人）到100,000泰铢以上（室外球场活动）都有。在LENGOLF，每人667–1,000泰铢就包含餐点、酒水和3小时高尔夫，只是室外方案的一个零头，截至2026年2月。',
      price_breakdown: [
        { item: 'LENGOLF小型套餐（10–15人）', price: '9,999泰铢（总价）', notes: '2个球位，3小时。含啤酒10瓶、鸡尾酒5杯、软饮无限畅饮，以及Smith & Co.的餐点。' },
        { item: 'LENGOLF中型套餐（15–25人）', price: '21,999泰铢（总价）', notes: '4个球位（整场包下），3小时。含啤酒20瓶、鸡尾酒10杯、软饮无限畅饮，以及Smith & Co.与Pizza Mania的餐点。' },
        { item: 'LENGOLF人均费用（小型，15人）', price: '约667泰铢', notes: '全包价。没有隐藏费用。' },
        { item: 'LENGOLF人均费用（中型，25人）', price: '约880泰铢', notes: '全包价。没有隐藏费用。' },
        { item: '室外球场 — 人均（经济型）', price: '3,000–4,000泰铢', notes: '果岭费、球童费与球车费。餐饮与交通另计。' },
      ...
      sections: [
        {
          ...
          body: '两种套餐都包含：专属球位使用、100多座世界世界名球场的模拟器体验、带计分与排行榜的比赛形式、啤酒（Singha与Asahi）、鸡尾酒、软饮无限畅饮，以及Smith & Co.的餐点拼盘（中型套餐还加上Pizza Mania）。场地方会把一切都布置好——赛制、计分、音乐——组织者带着团队来就行。可定制的部分包括：现场布置、定制奖杯、印制记分卡，以及按需求调整的餐单。',
        },
        {
  ...
  // claimed anywhere. related_slugs unchanged — all four are JA-translated.
  {
    ...
    content: {
      ...
      price_breakdown: [
        ...
        { item: 'LENGOLF — 無料体験レッスン', price: '0THB', notes: 'プロと1時間。その後のお申し込みは自由です。LINEまたはウェブサイトからご予約ください。' },
  ...
  // LENGOLF tint. related_slugs unchanged — all four targets are KO-translated.
  {
    ...
    content: {
      intro:
        '방콕의 골프 레슨 비용은 강사와 장소, 형식에 따라 시간당 1,800~5,000바트예요. LENGOLF에서는 PGA 자격을 갖춘 프로의 개인 레슨을 시간당 1,800바트부터 받으실 수 있고, 첫 1시간은 체험 레슨으로 무료예요 (2026년 2월 기준).',
      price_breakdown: [
  ...
  // all four EN targets are ZH-translated.
  {
    ...
    meta_description:
      '曼谷高尔夫课程价格：LENGOLF每小时1,800泰铢起，含1小时免费体验课；室外教练每小时2,000–5,000泰铢。室内模拟器教学与练习场课程全对比，截至2026年2月。',
    featured_image: null,
    schema_markup: null,
    status: 'published',
    category: 'pricing',
    ...
    content: {
      intro:
        '在曼谷上高尔夫课，每小时大约1,800–5,000泰铢，看教练、场地和形式而定。LENGOLF的一对一课程由具PGA资格的教练授课，每小时1,800泰铢起——而且第一个小时是免费体验课，截至2026年2月。',
      price_breakdown: [
        ...
        { item: 'LENGOLF — 免费体验课', price: '0泰铢', notes: '与教练上1小时，无任何附带条件。可通过LINE或网站预约。' },
      ...
      value_proposition:
        'LENGOLF的1小时免费体验课，把风险降到了零。先上一次，看看挥杆数据，再决定这条路适不适合你——一分钱都不用花。想继续系统学下去的话，我们的Starter入门套餐（11,000泰铢，含5小时教学、5小时练习时间和一副高尔夫手套）是曼谷最超值的新手套餐。',
      last_verified: '2026-02-19',
      sections: [
        {
          heading: '模拟器课程有什么不一样',
        ...
        {
          heading: '零基础的最佳路径',
          body: '如果你从来没打过高尔夫：先从免费体验课开始。要是觉得喜欢，那么Starter入门套餐（11,000泰铢）是最有体系的一条路——5小时教学打基础，再加5小时练习把它巩固下来，还送一副高尔夫手套让你上手。6个月的有效期意味着不用赶。上完Starter入门套餐之后，多数学员会转到5小时或10小时的教学套餐继续提升。',
        },
      ],
      curated_reviews: [
        {
