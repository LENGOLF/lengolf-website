...
> = {
  ...
  'hua-hin': {
    ja: {
      ...
      description:
        'ホアヒンとチャアムには、タイでも名高いゴルフコースが集まっています。ゴルフダイジェストのトップ100に選ばれたブラックマウンテンから、世界ランキングにも名を連ねるパイナップルバレーまで、いずれも山並みを背にしたロケーションに広がり、一部のコースからはタイランド湾も望めます。',
    },
    ko: {
      label: '후아힌',
      province: '쁘라추압키리칸 및 펫차부리',
      description:
        '후아힌과 차암에는 태국에서도 이름난 골프 코스가 모여 있습니다. 골프 다이제스트 100대 코스에 선정된 블랙 마운틴부터 세계 랭킹에 오른 파인애플 밸리까지, 모두 산맥을 배경으로 펼쳐지며 일부 코스에서는 태국만이 내려다보입니다.',
    },
    zh: {
      label: '华欣',
      province: '巴蜀府及佛丕府',
      description:
        '华欣与差安坐拥泰国一些最负盛名的高尔夫球场——从入选《高尔夫文摘》百佳榜的黑山球场，到跻身世界排名的菠萝谷球场，皆坐落于群山之间，部分球场还能远眺泰国湾。',
    },
    th: {
      label: 'หัวหิน',
      province: 'ประจวบคีรีขันธ์และเพชรบุรี',
      description:
        'หัวหินและชะอำเป็นที่ตั้งของสนามกอล์ฟที่มีชื่อเสียงที่สุดแห่งหนึ่งของไทย ตั้งแต่ Black Mountain สนามที่ติดอันดับ Golf Digest Top 100 ไปจนถึง Pineapple Valley สนามที่ติดอันดับโลก โดยทุกสนามตั้งอยู่ท่ามกลางแนวเทือกเขา และบางสนามมองเห็นวิวอ่าวไทยได้',
    },
  },
  'chiang-mai': {
    ja: {
