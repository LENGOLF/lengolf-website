  ...
  '3500-baht': {
    ...
    ja: {
      ...
      framing:
        ...
        '週末料金は30〜40%上がることが多く、この価格帯が真価を発揮するのは平日プレーです。価格帯上位の一部のコースにはキャディーへのチップの慣習があり、公表されているグリーンフィーに300〜500THB（2026年7月現在）がひそかに上乗せされます。',
    },
    ko: {
      ...
      framing:
        ...
        '주말 요금은 30~40% 오르는 경우가 많아서, 이 가격대는 평일 플레이에 가장 유용해요. 가격대 상단의 일부 코스에는 캐디 팁 관행이 있어서, 공시된 그린피에 300~500바트가 슬그머니 더해지기도 해요 (2026년 7월 기준).',
    },
    zh: {
      ...
      framing:
        ...
        '周末价格常上涨30–40%，所以这个价位段最适合平日打球。价位段上端的部分球场有球童小费惯例，会在公示的果岭费之外悄悄多出300–500泰铢，截至2026年7月。',
    },
  },
  '5000-baht': {
    th: {
