      ...
      list_items: [
        {
          ...
          pros: [
            'ไม่ต้องมีประสบการณ์กอล์ฟ มือใหม่มักทำคะแนนชนะเพื่อนร่วมงานที่เล่นกอล์ฟอยู่แล้วได้บ่อย ๆ',
    ...
    content: {
      ...
      list_items: [
        ...
        },
        {
          ...
          name: 'Blu-O Rhythm & Bowl — Siam Paragon',
          description:
            'โบว์ลิ่งที่ดีที่สุดในกรุงเทพฯ เมื่อวัดจากเกณฑ์ส่วนใหญ่ มี 16 เลน โบว์ลิ่งเรืองแสง ห้องคาราโอเกะ โต๊ะบิลเลียด และอาร์เคดรวมอยู่ในที่เดียว ตั้งอยู่ที่สยามพารากอนชั้น B2 เป็นตัวเลือกที่ไว้ใจได้สำหรับกลุ่ม 4-20 คน และเป็นไม่กี่แห่งที่สลับเล่นหลายกิจกรรมได้ ราคาถือว่าสมเหตุสมผลสำหรับใจกลางกรุงเทพฯ',
          pros: [
        ...
        },
        {
          ...
          name: 'Karaoke at Zaa, The Vocal — Thong Lo',
          description:
            'กรุงเทพฯ มีร้านคาราโอเกะนับสิบแห่ง แต่ The Vocal ในทองหล่อเป็นหนึ่งในที่ดีที่สุดสำหรับกลุ่มที่ใช้ภาษาอังกฤษ ทั้งห้องให้เลือกหลายขนาด คลังเพลงสากล และบริการอาหารเครื่องดื่มตลอดเวลา ห้องส่วนตัวรองรับตั้งแต่ 2 คนไปจนถึง 20 คนขึ้นไป รูปแบบนี้เหมาะกับกลุ่มที่มีคนหลากหลายซึ่งอยากได้ความสังสรรค์โดยไม่ต้องกดดันกับเกมหรือทักษะ',
          pros: [
        ...
        },
        {
          ...
          name: 'Art in Paradise Bangkok — Ratchadaphisek',
          description:
            'พิพิธภัณฑ์ศิลปะ 3 มิติแบบอินเทอร์แอกทีฟที่ผู้ชมกลายเป็นส่วนหนึ่งของภาพลวงตา เป็นกิจกรรมกลางวันเป็นหลัก และเหมาะกับครอบครัวและกลุ่มนักท่องเที่ยว เนื้อหาสนุกสำหรับการถ่ายรูปแต่ไม่ลึกพอสำหรับการกลับมาซ้ำ คุ้มค่ามากที่ราคาราว 500 บาทต่อคน',
          pros: [
          ...
          cons: [
            'เหมาะกับนักท่องเที่ยวมากกว่าคนที่อยู่ที่นี่ในค่ำคืนออกเที่ยว',
            'เป็นประสบการณ์แบบตั้งรับ คือดูและถ่ายรูป',
    ...
    content: {
      ...
      list_items: [
        ...
        },
        {
          ...
          name: 'The Vocal Karaoke — Thong Lo',
          description:
            'ห้องคาราโอเกะส่วนตัวเป็นรูปแบบงานวันเกิดยอดนิยมในกรุงเทพฯ เพราะทุกคนได้ร่วม เครื่องดื่มไหลลื่น และบรรยากาศค่อย ๆ สนุกขึ้นเองภายใน 3 ชั่วโมง The Vocal ในทองหล่อเป็นตัวเลือกที่แข็งแรงที่สุดสำหรับกลุ่มที่ใช้ภาษาอังกฤษ ทั้งห้องขนาดใหญ่ คลังเพลงสากล และบริการเครื่องดื่มกับอาหารเต็มรูปแบบ เหมาะที่สุดกับกลุ่ม 6-20 คน',
          pros: [
      ...
      list_items: [
        {
          ...
          cons: [
            'ความรู้สึกไม่เหมือนหญ้าจริงและสภาพกลางแจ้ง',
        ...
        },
        {
          ...
          cons: [
            ...
            'เลย์เอาต์ไม่ค่อยให้อภัย ไม่เหมาะกับแฮนดิแคปสูง',
          ],
          is_lengolf: false,
          address: '59/9 Moo 3, Nakhon Chai Si, Nakhon Pathom',
          website: 'https://www.nikantigolfclub.com/',
        ...
        },
        {
          ...
          name: 'Driving Range at Sinthorn Golf Academy',
          description:
            'สนามไดรฟ์แบบยืนเดี่ยวที่ดีที่สุดในใจกลางกรุงเทพฯ เป็นสนามไดรฟ์หลายชั้นบนถนนวิทยุ ห่างจาก BTS ชิดลม 1 กิโลเมตร มีตัวเลือกการสอนหลายแบบ เหมาะกับการวอร์มอัป การซ้อม และคนที่ไม่มีเวลาออกรอบเต็มรูปแบบ ราคาต่อถังอยู่ที่ราว 200-400 บาท',
          pros: [
          ...
          cons: [
            'ซ้อมได้เฉพาะไดรฟ์และเหล็ก ไม่มีลูกสั้น',
            'คนแน่นได้ในช่วงเย็น',
    ...
    content: {
      ...
      list_items: [
        ...
        },
        {
          ...
          cons: [
            'ใหญ่จนล้นสำหรับคนที่ไม่ชอบเดินห้าง',
            'คนแน่นมากในวันหยุดสุดสัปดาห์',
          ],
          is_lengolf: false,
          address: '4/1-4/6 Ratchadamri Rd, Pathumwan',
