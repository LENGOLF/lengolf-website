...
export const course: GolfCourse = {
  ...
  locales: {
    ...
    ko: {
      ...
      prose: {
        overview: `Dragon Hills Golf & Country Club은 Jim Engh가 랏차부리주 Pak Tho 지구의 정글로 뒤덮인 산비탈 1,500에이커에 설계한 코스예요. 다만 위치와 성격 때문에 예약 플랫폼에서는 늘 깐짜나부리·River Kwai 코스들과 한데 묶여 소개됩니다. 1994년에 문을 연 이곳은 방콕에서 90분 이내에 있는 레이아웃 가운데 지형이 가장 극적인 축에 드는데, 캐디와 카트를 포함한 공식 방문객 패키지가 평일 1,560바트, 주말 1,750바트로(2026년 7월 기준) 이 지역에서 가성비 좋은 진지한 골프 경험 가운데 하나로 꼽힙니다. (태국 국적자는 이중 가격제로 더 낮은 요금을 냅니다.) 부지의 고도와 숲으로 덮인 지형은 방콕 가까운 근교를 지배하는 평탄한 파크랜드 코스와는 사뭇 다른 플레이 경험을 만들어 내, 먼 길을 가지 않고도 의미 있는 지형을 즐기고 싶은 골퍼가 자주 찾는 곳이 됩니다.`,
    ...
    zh: {
      title: `Dragon Hills Golf & Country Club全包套餐 — 叻丕Jim Engh山地球场攻略与球杆租借`,
