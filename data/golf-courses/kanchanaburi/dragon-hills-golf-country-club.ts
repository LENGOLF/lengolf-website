  ...
  locales: {
    ...
    th: {
      ...
      prose: {
        ...
        tips: `หลุม 12 คือหลุมที่ต้องเตรียมตัว ช็อตเข้าดาวน์ฮิลล์สู่กรีนเกาะให้รางวัลกับการเลือกไม้แบบระมัดระวัง และลงโทษลูกที่ยาวเกินหรือไปทางซ้าย การเปลี่ยนระดับความสูงอย่างมากทำให้รถกอล์ฟที่รวมอยู่ในแพ็กเกจมีประโยชน์จริง โดยเฉพาะในช่วงบ่ายที่อากาศร้อน ที่ 1,560 บาทวันธรรมดาแบบรวมทุกอย่างสำหรับภูมิประเทศภูเขาที่ออกแบบโดย Jim Engh นั้น Dragon Hills ให้ความคุ้มค่าอย่างจริงจัง แต่ควรสอบถามราคาปัจจุบันกับสนามโดยตรง เพราะค่าธรรมเนียมเปลี่ยนแปลงตามฤดูกาล การขับรถ 90 นาทีจากกรุงเทพฯ ทำให้เป็นทริปไปกลับในวันเดียวได้หากออกเดินทางแต่เช้า โดยไม่ต้องค้างคืน`,
    ...
    ko: {
      ...
      meta_description: `Dragon Hills Golf & Country Club은 Jim Engh이 랏차부리 산지 1,500에이커에 설계한 코스예요. 방문객 패키지는 평일 1,560바트부터로 캐디와 카트 포함(2026년 7월 기준). 아일랜드 그린 파3 시그니처 홀, 방콕에서 90분.`,
      prose: {
    ...
    zh: {
      ...
      prose: {
        overview: `Dragon Hills Golf & Country Club是Jim Engh在叻丕府Pak Tho县1,500英亩丛林覆盖的山坡上打造的球场——不过因为它的位置与气质，在各订球平台上总是和北碧、桂河一带的球场归在一起。球场1994年开放，至今仍是曼谷90分钟车程内地势最富戏剧性的布局之一：官方访客套餐平日1,560泰铢、周末1,750泰铢——含球童与球车——让它跻身本地区最超值的正经高尔夫体验之列，截至2026年7月。（泰国本国人适用较低的双重定价。）这片场地的海拔与林地地形，带来的体验与主宰曼谷近郊的那些平坦林间公园式球场相去甚远，也让它成为想要有分量的地势、又不愿长途驱车的球手常去的去处。`,
        ...
        tips: `第12洞是需要提前做准备的一洞：打向岛屿果岭的下坡攻击，会奖励保守的选杆，也会惩罚任何偏长或偏左的球。显著的高低落差，让套餐里已含的球车真正派上用场，午后暑热中尤其如此。以平日1,560泰铢全包玩到Jim Engh的山地地形，截至2026年7月，Dragon Hills堪称超值——但请直接向球会确认当前价格，因为费用会随季节变化。从曼谷90分钟的车程，让它作为清早出发的一日游完全可行，无需过夜。`,
        location_and_access: `Dragon Hills位于叻丕府Pak Tho县，行政上与北碧分属不同辖区，但通常被归入桂河一带。从曼谷出发，车程约90分钟——明显短于Saiyoke或Bo Phloi等县的球场。从曼谷往南、往西，经35号或4号公路接入Pak Tho；自驾是现实的选择。叻丕府南面与北碧接壤，这一带的山地地形造就了Dragon Hills那种抬升的球场性格，把它和更靠近城市的低地选择区分开来。`,
