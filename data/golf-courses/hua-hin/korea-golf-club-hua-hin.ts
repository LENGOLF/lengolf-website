...
export const course: GolfCourse = {
  ...
  prose: {
    overview: `Hua Hin Korea Golf Club is one of the cheapest 18-hole golf courses in Thailand, with a published all-in package of just 800 THB covering green fee, caddie and cart — among the cheapest full 18-hole rounds anywhere in Thailand. The course was originally built in 1992 as Milford Golf Club by designer Robert McFarland, measuring 6,614 yards off the back tees at par 72. Over the decades it passed through several name changes — Milford Paradise, The Eagle Milford, Hua Hin Seoul Country Club — before Korean management rebranded it as the current Hua Hin Korea Golf Club. Located roughly 40 minutes south of Hua Hin town in Pran Buri, Prachuap Khiri Khan, the course sits in a mountain-framed coastal valley that gives it a scenic setting for the price. For golfers on a strict budget, or those who simply want a casual round without the pressure of a premium venue, this is a viable option — but the maintenance standards are modest and anyone accustomed to well-manicured conditions should set expectations accordingly.`,
