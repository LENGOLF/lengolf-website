...
export const course: GolfCourse = {
  ...
  locales: {
    ...
    zh: {
      ...
      prose: {
        overview: `Hua Hin Korea Golf Club是泰国最便宜的18洞球场之一，公布的全包套餐只要800泰铢，果岭费、球童与球车全都包含在内——放眼全泰国，打满18洞的价格也很少低于这个数。这座球场最初于1992年以Milford Golf Club的名字开门，由Bob McFarland设计，后发球台量起6,614码，标准杆72。此后数十年里它几度易名，先后叫过Milford Paradise、The Eagle Milford与Hua Hin Seoul Country Club，直到韩资管理层将它重新定位为如今的Hua Hin Korea Golf Club。球场位于华欣镇以南约40分钟车程的巴蜀府Pran Buri，坐落在群山环抱的沿海谷地里，就这个价位而言景色相当出色。如果你预算吃紧，或者只想轻松打一场、不必承受高端球场的压力，这里是个可行的选择——但养护标准只算一般，习惯了精致草况的球友最好先把期待值放到合适的位置。`,
    ...
    ja: {
      ...
      prose: {
        overview: `Hua Hin Korea Golf Clubは、タイでもっとも安い18ホールコースのひとつです。公表されているのはグリーンフィー・キャディー・カートを含む800THBのオールインパッケージのみで、フル18ホールのラウンド料金としてはタイ全土でも最安クラスに入ります。開場は1992年、当時の名称はMilford Golf Clubで、設計はBob McFarlandが手がけました。バックティーからの全長は6,614ヤード、パー72です。その後の数十年でMilford Paradise、The Eagle Milford、Hua Hin Seoul Country Clubと何度か名前が変わり、韓国系の経営陣によるリブランドを経て現在のHua Hin Korea Golf Clubになりました。所在地はホアヒンの町から南へ車で約40分、プラチュアップキリカン県のプランブリー。山に囲まれた海沿いの谷あいに広がっており、料金を考えれば景観はかなり贅沢です。予算をできるだけ抑えたい方や、高級コース特有の緊張感なしに気軽に回りたい方には十分に現実的な選択肢といえます。ただし整備の水準は控えめで、手入れの行き届いたコンディションに慣れている方は期待値を調整しておくとよいでしょう。`,
