...
export const course: GolfCourse = {
  ...
  locales: {
    ...
    th: {
      title: `Hua Hin Korea Golf Club ปราณบุรี — แพ็กเกจแบบรวมทุกอย่าง รีวิวสนาม และเช่าไม้กอล์ฟ`,
    ...
    zh: {
      title: `Hua Hin Korea Golf Club全包套餐与球场攻略 — 800泰铢打18洞`,
      meta_description: `Hua Hin Korea Golf Club公布价为800泰铢全包，含果岭费、球童与球车。这座18洞标准杆72的球场位于华欣以南的Pran Buri，另附从曼谷出发前就能备好的LENGOLF球杆租借。`,
      prose: {
        overview: `Hua Hin Korea Golf Club是泰国最便宜的18洞球场之一，公布的全包套餐只要800泰铢，果岭费、球童与球车全都包含在内——放眼全泰国，这也属于打满18洞最便宜的价格之一。这座球场最初于1992年以Milford Golf Club的名字开门，由Bob McFarland设计，后发球台量起6,614码，标准杆72。此后数十年里它几度易名，先后叫过Milford Paradise、The Eagle Milford与Hua Hin Seoul Country Club，直到韩资管理层将它更名为如今的Hua Hin Korea Golf Club。球场位于华欣镇以南约40分钟车程的巴蜀府Pran Buri，坐落在群山环抱的沿海谷地里，就这个价位而言景色相当出色。如果你预算吃紧，或者只想轻松打一场、不必承受高端球场的压力，这里是个可行的选择——但养护标准只算一般，习惯了精致草况的球友最好先把期待值放到合适的位置。`,
    ...
    ja: {
      title: `Hua Hin Korea Golf Club（ホアヒン）— パッケージ料金・コース紹介・クラブレンタル`,
      meta_description: `公表料金はグリーンフィー・キャディー・カート込みで800THBのオールインクルーシブ。Hua Hin Korea Golf Clubはホアヒンの南、プラチュアップキリカン県プランブリーにある18ホール・パー72のコースです。バンコクで用意できるLENGOLFのクラブレンタルもご案内します。`,
      prose: {
        overview: `Hua Hin Korea Golf Clubは、タイでもっとも安い18ホールコースのひとつです。公表されているグリーンフィー・キャディー・カート込みのオールインクルーシブはわずか800THBで、フル18ホールのラウンド料金としてはタイ全土でも最安クラスに入ります。開場は1992年、当時の名称はMilford Golf Clubで、設計はBob McFarlandが手がけました。バックティーからの全長は6,614ヤード、パー72です。その後の数十年でMilford Paradise、The Eagle Milford、Hua Hin Seoul Country Clubと何度か名前が変わり、韓国系の経営陣によるリブランドを経て今のHua Hin Korea Golf Clubになりました。所在地はホアヒンの町から南へ車で約40分、プラチュアップキリカン県のプランブリー。山に囲まれた海沿いの谷あいに広がっており、料金を考えれば景観はかなり贅沢です。予算をできるだけ抑えたい方や、高級コース特有の緊張感なしに気軽に回りたい方には十分に現実的な選択肢といえます。ただし整備の水準は控えめで、手入れの行き届いたコンディションに慣れている方は期待値を調整しておくとよいでしょう。`,
        ...
        tips: `Hua Hin Korea Golf Clubを選ぶ最大の理由は料金です。グリーンフィー・キャディー・カートを含む800THBのオールインクルーシブは、タイ国内で手に入る18ホールのラウンド料金として最安クラスに入ります。このコストパフォーマンスは本物ですが、期待値の調整は必要。コンディションにはばらつきがあり、ホアヒン周辺のほかのクラブより見劣りするという声が複数寄せられています。バンカーの水たまりやぬかるんだフェアウェイのリスクを下げたいなら、11月〜2月の乾季に訪れるのがおすすめです。混み合うことが少ないため進行は概して速く、前の組を追い越したり先行したりする場面も多くなります。予約は電話（+66 63 218 6636）またはFacebookページから。ウォークインもたいてい受け付けてもらえますが、事前に電話を入れておくと安心です。コース内の飲食設備は限られているので、水や軽食は持参しましょう。キャディーの人数は多くないため、大人数で回る場合は事前に手配できるかどうか確認してください。`,
