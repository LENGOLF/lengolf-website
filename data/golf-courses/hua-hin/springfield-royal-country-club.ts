  ...
  locales: {
    ...
    ja: {
      ...
      prose: {
        ...
        layout_and_experience: `SpringfieldにおけるNicklausの設計は、ホアヒン北側の地形を実に巧みに生かしています。この一帯は、内陸のテナセリム山脈へ向かうにつれて、平坦な海岸平野から緩やかに起伏する丘陵へと表情を変えていきます。ティーは5種類用意されており、幅広いハンディキャップのゴルファーが楽しめる一方、チャンピオンシップティーからは厳しい試練となります。27ホールはA、B、Cと名付けられた3つの9ホールに分かれ、どの組み合わせでも18ホールのラウンドが成立します。Nicklausスタイルの特徴はコース全体に表れており、ティーショットの落としどころはゆったりしているのにグリーンへ近づくほど狭まり、戦略的に配されたウォーターハザードは精度の高いショットに報い、大きくうねるパッティング面は入念なライン読みを求めます。山並みを背にした景観は、この地域の海寄りのレイアウトとは異なる趣を生み出します。2005年に加わった3つ目の9ホールは、フェアウェイがより狭く、グリーンを狙う角度も一段と厳しいことから、3つのループのなかで最も難しいと一般に見なされています。ラウンドの前後にレッスンを受けたい方には、Golf Academyの施設も用意されています。`,
