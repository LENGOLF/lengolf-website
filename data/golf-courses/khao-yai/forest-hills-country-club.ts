  ...
  locales: {
    ...
    ja: {
      ...
      prose: {
        ...
        tips: `予約サイトのパッケージ（平日約1,350THB、週末約1,600THB、キャディーとカート込み）が最も条件のよいことが多いので、出発前にウォークイン料金と比較しておくとよいでしょう（2026年8月現在）。これに加えて、キャディーへのチップは400THBが慣例的な最低額です。27ホールあるため、訪問日にどの18ホールの組み合わせが使われるかを確認しておいてください。週末は一部のループに人が集中することがあります。ムアクレックという立地はカオヤイ回廊の他のコースにも近く、近隣のコースと組み合わせて週末に複数ラウンドを回る行程も組めます。`,
    ...
    ko: {
      ...
      meta_description: `Forest Hills Country Club(현재 Sir James Country Club)은 사라부리주 Muak Lek의 27홀 파크랜드 코스예요. 예약 플랫폼 패키지는 평일 약 1,350바트, 주말 약 1,600바트로 캐디와 1인승 카트가 포함됩니다 (2026년 8월 기준). 방콕에서 90분 거리이고 클럽 대여 정보까지 정리했어요.`,
      prose: {
        ...
        tips: `예약 플랫폼 패키지(평일 약 1,350바트, 주말 약 1,600바트, 캐디와 카트 포함)가 대체로 가장 유리하니, 출발 전에 워크인 요금과 비교해 보세요 (2026년 8월 기준). 캐디 팁은 최소 400바트가 관례이고 이 금액에 더해 드립니다. 27홀 코스라 방문하는 날 어떤 18홀 조합이 열리는지 미리 확인해 두는 편이 좋아요. 주말에는 특정 루프에 사람이 몰릴 수 있습니다. Muak Lek이라는 위치 덕분에 카오야이 축의 다른 코스들과 가까워, 근처 골프장 라운딩과 묶어 여러 코스를 도는 주말 일정을 짜기도 좋아요.`,
