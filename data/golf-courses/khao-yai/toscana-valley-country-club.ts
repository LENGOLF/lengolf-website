  ...
  locales: {
    ...
    ja: {
      ...
      prose: {
        ...
        tips: `Toscana Valleyは平日の朝にさっと回るようなコースではなく、目的地として1日をあてる場所です。できればリゾートでの宿泊と組み合わせてください。グリーンフィー、キャディー、カートを含むオールインクルーシブ料金は平日およそ5,000THB、週末およそ6,000THBで、PGA基準の山岳コースとしては本物の価値があります。コンディションと景観が最も良いのは涼季（11月から2月）です。バンコクからはおよそ2時間。打ち上げのホールで日中の暑さに当たらないよう、早めに出発してください。高低差があるぶんクラブ選択が決定的に重要になるため、ヤーデージの補正についてはキャディーの助言が欠かせません。ティータイムはリゾートの公式サイトか電話（+66 87 549 7222）から直接ご予約ください。`,
    ...
    ko: {
      ...
      meta_description: `Toscana Valley Country Club은 카오야이 고지대의 Bob McFarland 설계 18홀 코스예요. 올인클루시브 요금은 평일 약 5,000바트, 주말 약 6,000바트로 그린피와 캐디, 카트가 포함됩니다. 코스 가이드와 클럽 대여 정보까지 담았어요.`,
      prose: {
