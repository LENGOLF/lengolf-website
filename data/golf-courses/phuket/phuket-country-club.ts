...
export const course: GolfCourse = {
  ...
  prose: {
    ...
    rental_cta_context: `Heading to Phuket Country Club on your island trip? If your travel plan includes a night in Bangkok before or after, rent premium Callaway clubs delivered to your Bangkok hotel — skip airline baggage fees entirely.`,
  },
  locales: {
    en: {
    ...
    th: {
      ...
      prose: {
        ...
        rental_cta_context: `กำลังจะไป Phuket Country Club ในทริปเที่ยวเกาะของคุณใช่ไหม หากแผนการเดินทางมีการค้างคืนที่กรุงเทพฯ ก่อนหรือหลังทริป สามารถเช่าไม้กอล์ฟพรีเมียม Callaway ส่งถึงโรงแรมของคุณในกรุงเทพฯ ได้ ตัดปัญหาค่าโหลดสัมภาระของสายการบินไปได้ทั้งหมด`,
      },
    },
    ko: {
      ...
      prose: {
        ...
        rental_cta_context: `섬 여행길에 Phuket Country Club을 찾을 계획이라면, 일정에 방콕에서의 하루가 앞뒤로 끼어 있는지 살펴보세요. Callaway 프리미엄 클럽을 방콕 호텔까지 받아 보면 항공사 수하물 요금을 통째로 아낄 수 있어요.`,
      },
    },
    zh: {
      ...
      prose: {
        ...
        rental_cta_context: `如果你的海岛行程会去Phuket Country Club，而前后又在曼谷住上一晚，可以把Callaway高级球杆直接租到你的曼谷酒店，把航空公司的托运行李费整个省下来。`,
      },
    },
    ja: {
      ...
      prose: {
        ...
        rental_cta_context: `島旅行でPhuket Country Clubへ向かう予定ですか。旅程にバンコクでの前泊や後泊が含まれるなら、Callawayのプレミアムクラブをバンコクのホテルまでお届けするレンタルをご利用ください。航空会社の手荷物料金を丸ごと節約できます。`,
      },
    },
  },
  status: 'published',
