...
export const course: GolfCourse = {
  ...
  locales: {
    ...
    th: {
      ...
      prose: {
        overview: `Lanna Golf Course เป็นสนามกอล์ฟ 27 หลุมกลางเมืองที่ดำเนินการโดยกองทัพบก ภายในศูนย์กีฬาลานนา บนถนนโชตนา อำเภอเมืองเชียงใหม่ ห่างจากใจกลางเมืองประมาณ 10 นาที เปิดให้บริการตั้งแต่ปี 1974 จึงเป็นสนามกอล์ฟที่เก่าแก่ที่สุดและอยู่ใกล้ใจกลางเมืองมากที่สุดในเชียงใหม่ สนามทั้ง 27 หลุมแบ่งเป็น 3 คอร์ส คอร์สละ 9 หลุม โดยสองคอร์สเป็นช่วงที่ยาวกว่าและมีแนวต้นไม้ขนาบ ส่วนคอร์สที่สามซึ่งสั้นกว่าวิ่งผ่านบริเวณสนามแข่งของเชียงใหม่บางส่วน สนามมีลักษณะราบเรียบและอนุญาตให้เดินเล่นได้ จึงเป็นหนึ่งในไม่กี่สนามของเชียงใหม่ที่การสะพายถุงหรือใช้รถลากถุงกอล์ฟทำได้จริง ค่ากรีนฟีจัดอยู่ในกลุ่มย่อมเยาที่สุดในภาคเหนือ`,
        ...
        tips: `อัตราเหมา 1,350 บาทซึ่งเท่ากันทุกวันได้รวมค่าแคดดี้แล้ว (เพิ่มประมาณ 400 บาทหากต้องการรถกอล์ฟ) และได้รับการตรวจสอบยืนยันอีกครั้งกับข้อมูลราคาปี 2026 ทั้งนี้ควรยืนยันกับสนามโดยตรงที่ +66 53 221 911 หรือผ่าน golflannachiangmai.com ก่อนเดินทาง สนามราบเรียบจึงอนุญาตให้เดินเล่นและแนะนำให้เดิน วันธรรมดาจะเงียบกว่าวันเสาร์อาทิตย์ สนามอยู่ห่างจากย่านไนท์บาซาร์และย่านนิมมานเพียง 10 นาที เหมาะกับการออกรอบเช้าตรู่ก่อนไปเที่ยวชมเมือง`,
