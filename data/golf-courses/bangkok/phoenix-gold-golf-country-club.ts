...
export const course: GolfCourse = {
  ...
  locales: {
    en: {
      ...
      // That is accepted deliberately — the brand and the former name both land
      // in the visible span, and "Green Fees & Guide" is the half worth losing.
      // The word "airport" appears nowhere: airport intent belongs to
