...
export const course: GolfCourse = {
  ...
  locales: {
    ...
    zh: {
      ...
      prose: {
        overview: `Bangpoo Golf & Sports Club在泰国高尔夫史上有着独特地位——它是泰国唯一一座由阿诺德·帕尔默（Arnold Palmer）设计的球场，也是全亚洲极少数的帕尔默作品之一。球场地处曼谷市中心以南约40公里的北榄府，紧邻泰国湾海岸，于1991年在一片缓坡地形上开放，成年树木遮荫，天然野花点缀其间。临海的位置带来稳定的海风，让气温比更深入内陆的球场更为凉爽——在曼谷闷热的月份里，这是实实在在的舒适加分。球会拥有一批忠实的本地拥趸，尤其是Bangna一带的居民，被它有竞争力的价格和帕尔默布局的声望所吸引。来自海外的访客球手则欣赏这里地道的1990年代热带公园式氛围，以及平日相对不拥挤的开球表。从后置发球台量起7,048码，配以TifEagle果岭，球场是一场货真价实的锦标赛考验，却又不会让中差点球手难以招架。`,
