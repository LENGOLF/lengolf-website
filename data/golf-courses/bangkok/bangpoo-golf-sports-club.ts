...
export const course: GolfCourse = {
  ...
  locales: {
    ...
    th: {
      ...
      prose: {
        overview: `Bangpoo Golf & Sports Club มีตำแหน่งพิเศษในประวัติศาสตร์กอล์ฟไทยในฐานะสนามแห่งเดียวในประเทศไทยที่ออกแบบโดย Arnold Palmer และเป็นหนึ่งในผลงานไม่กี่แห่งของ Palmer ในทวีปเอเชียทั้งหมด ตัวสนามตั้งอยู่ใกล้ชายฝั่งอ่าวไทยในจังหวัดสมุทรปราการ ห่างจากใจกลางกรุงเทพฯ ไปทางใต้ราว 40 กิโลเมตร เปิดให้บริการในปี 1991 บนภูมิประเทศที่ลาดเอียงเล็กน้อย ร่มรื่นด้วยต้นไม้ใหญ่และแซมด้วยดอกไม้ป่าตามธรรมชาติ ความใกล้ทะเลนำพาสายลมพัดสม่ำเสมอที่ช่วยให้อุณหภูมิเย็นกว่าสนามที่อยู่ลึกเข้าไปในแผ่นดิน นับเป็นโบนัสความสบายที่แท้จริงในช่วงเดือนที่ร้อนอบอ้าวของกรุงเทพฯ สนามมีกลุ่มลูกค้าท้องถิ่นที่เหนียวแน่น โดยเฉพาะผู้ที่พำนักในย่านบางนา ซึ่งดึงดูดด้วยราคาที่แข่งขันได้และเกียรติภูมิของเลย์เอาต์ฝีมือ Palmer นักกอล์ฟที่มาเยือนจากต่างประเทศชื่นชอบบรรยากาศพาร์กแลนด์เขตร้อนแบบยุค 1990 ที่แท้จริง และตารางทีไทม์วันธรรมดาที่ค่อนข้างไม่แออัด ด้วยระยะ 7,048 หลาจากแท่นทีหลังและกรีนพันธุ์ TifEagle สนามเล่นได้สมกับเป็นบททดสอบระดับแชมเปียนชิพโดยไม่โหดเกินไปสำหรับผู้เล่นแฮนดิแคปกลาง`,
        layout_and_experience: `เลย์เอาต์ 18 หลุมฝีมือ Palmer วางเส้นทางพาดผ่านภูมิประเทศที่ลาดเอียง ซึ่งไม่ค่อยพบในเขตกรุงเทพฯ ที่ราบเรียบ และใช้พืชพรรณธรรมชาติกับอุปสรรคน้ำอย่างเต็มที่ ต้นไม้ใหญ่กรอบแฟร์เวย์เกือบทุกหลุม ลดความกว้างเชิงสายตาจากแท่นทีโดยไม่สร้างจุดบอดที่ไม่เป็นธรรม สายลมชายฝั่งเป็นปัจจัยคงที่ ทำให้ต้องปรับการเลือกไม้ขึ้นหนึ่งถึงสองเบอร์ในหลุมที่โล่งลม และอาจทำให้เก้าหลุมแรกเล่นยากขึ้นมากในเช้าที่ลมแรง อุปสรรคน้ำปรากฏราวเก้าหลุม มักวางไว้เพื่อลงโทษไลน์ที่รุกมากเกินไปจากแท่นทีมากกว่าจะลงโทษช็อตแอพโพรชที่เล่นได้ดี กรีนที่ปลูกด้วยหญ้าเบอร์มิวดา TifEagle รับลูกได้ดีที่ความเร็วปานกลางและพัตต์นิ่งหลังการกลิ้งในตอนเช้า จังหวะการเล่นผ่อนคลายตามมาตรฐานกรุงเทพฯ โดยมีจุดกดดันจากกลุ่มที่ต่อกันน้อย ค่าเรตติ้งสนาม 72.5 พร้อมสโลป 121 ยืนยันลักษณะระดับปานกลางถึงท้าทาย ตรงไปตรงมาสำหรับนักกอล์ฟสแครช และคุ้มค่าสำหรับผู้เล่นแฮนดิแคปหลักเดียวที่บริหารตำแหน่งลูกจากแท่นทีได้ดี`,
        ...
        location_and_access: `Bangpoo Golf & Sports Club ตั้งอยู่เลขที่ 191 หมู่ 3 ตำบลแพรกษาใหม่ อำเภอเมืองสมุทรปราการ จังหวัดสมุทรปราการ 10280 สนามอยู่ห่างจากใจกลางกรุงเทพฯ ไปทางใต้ประมาณ 40 กิโลเมตร ใช้เวลาราว 50 นาทีทางรถยนต์ผ่านทางด่วนบางนา-ตราด และอยู่ห่างจากสนามบินนานาชาติสุวรรณภูมิราว 30 นาที ไม่มีขนส่งสาธารณะที่สะดวกเชื่อมถึงสนาม แท็กซี่ Grab หรือรถส่วนตัวจึงเป็นทางเลือกเดียว`,
        rental_cta_context: `การมุ่งลงใต้ไป Bangpoo จากกรุงเทพฯ ง่ายขึ้นมากเมื่อไม่มีถุงกอล์ฟกินพื้นที่ครึ่งหนึ่งของท้ายรถ LENGOLF จัดส่งชุดไม้กอล์ฟให้เช่ายี่ห้อ Titleist, Callaway, TaylorMade และ Ping ถึงโรงแรมของคุณในกรุงเทพฯ ตั้งแต่เย็นก่อนวันออกรอบ เพื่อให้คุณเดินทางแบบไม่ต้องแบกสัมภาระ`,
      },
    },
    ko: {
      ...
      prose: {
        ...
        location_and_access: `Bangpoo Golf & Sports Club의 주소는 191 Moo 3, Phraek Gasa Mai, Mueang Samut Prakan, Samut Prakan 10280이에요. 코스는 방콕 도심에서 남쪽으로 약 40km 떨어져 있고, 방나–뜨랏 고속도로로 차로 약 50분 거리입니다. 수완나품 국제공항에서는 대략 30분이에요. 클럽으로 연결되는 현실적인 대중교통은 없어서 택시나 Grab, 자가용이 유일한 선택입니다.`,
        rental_cta_context: `방콕에서 남쪽 Bangpoo로 향할 때 트렁크 절반을 차지하는 골프백이 없으면 훨씬 수월해요. LENGOLF는 Titleist, Callaway, TaylorMade, Ping 대여 세트를 라운딩 전날 저녁 방콕 호텔로 배달해 드려서 가볍게 이동할 수 있습니다.`,
      },
    },
    zh: {
      ...
      prose: {
        overview: `Bangpoo Golf & Sports Club在泰国高尔夫史上有着独特地位——它是泰国唯一一座由Arnold Palmer设计的球场，也是全亚洲极少数的帕尔默作品之一。球场地处曼谷市中心以南约40公里的北榄府，紧邻泰国湾海岸，于1991年在一片缓坡地形上开放，成年树木遮荫，天然野花点缀其间。临海的位置带来稳定的海风，让气温比更深入内陆的球场更为凉爽——在曼谷闷热的月份里，这是实实在在的舒适加分。球会拥有一批忠实的本地拥趸，尤其是Bangna一带的居民，被它有竞争力的价格和帕尔默布局的声望所吸引。来自海外的访客球手则欣赏这里地道的1990年代热带公园式氛围，以及平日相对不拥挤的开球表。从后置发球台量起7,048码，配以TifEagle果岭，球场是一场货真价实的锦标赛考验，却又不会让中差点球手难以招架。`,
        ...
        tips: `平日清晨的条件最佳：球手更少、空气更凉、果岭刚修剪过。周末清早的开球时段（从早上6点起）人潮最盛、收费也最高——正午之后的下午时段则明显便宜。所有套餐都含球童服务，且球童经验丰富，因此不妨采纳他们就风向调整选杆的本地经验。球场位于北榄府，经Bangna–Trat高速抵达；从曼谷市中心预留50分钟，从素万那普机场预留30分钟。着装要求有领上衣——可穿短裤。Arnold Palmer的拥趸多半会想在标注着他这次罕见亚洲之作的球场标牌前拍张照。`,
        location_and_access: `Bangpoo Golf & Sports Club地址为191 Moo 3, Phraek Gasa Mai, Mueang Samut Prakan, Samut Prakan 10280。球场在曼谷市中心以南约40公里，经Bangna–Trat高速车程约50分钟。距素万那普国际机场约30分钟。没有实用的公共交通连通球会；出租车、Grab或私家车是唯一的选择。`,
        rental_cta_context: `从曼谷南下前往Bangpoo，没了占据半个后备箱的球包会轻松许多。LENGOLF会在下场前一晚把Titleist、Callaway、TaylorMade和Ping的租借球杆送到你的曼谷酒店，让你轻装出行。`,
      },
    },
    ja: {
      ...
      prose: {
        ...
        location_and_access: `Bangpoo Golf & Sports Clubの所在地は191 Moo 3, Phraek Gasa Mai, Mueang Samut Prakan, Samut Prakan 10280です。コースはバンコク中心部から南へ約40km、バンナー・トラート高速道路経由で車で約50分の場所にあります。スワンナプーム国際空港からはおよそ30分です。実用的な公共交通の接続はなく、タクシー、Grab、あるいは自家用車が唯一の手段となります。`,
        rental_cta_context: `バンコクから南のBangpooへ向かうなら、トランクの半分を占領するゴルフバッグがないほうがずっと楽です。LENGOLFはTitleist、Callaway、TaylorMade、Pingのレンタルセットを、ラウンド前夜にバンコクのホテルへお届けするので、身軽に移動できます。`,
      },
    },
  },
  status: 'published',
