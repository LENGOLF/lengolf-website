...
export const course: GolfCourse = {
  ...
  prose: {
    ...
    rental_cta_context: `Flying Bangkok to Phuket with Katathong on the itinerary? LENGOLF delivers premium rental sets — Callaway Paradym, Warbird, REVA — to your Bangkok hotel, so you land at HKT and drive straight to Phang Nga without the hassle or fees of checking golf bags.`,
  },
  locales: {
    en: {
