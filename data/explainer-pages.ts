...
export const explainerPages: ExplainerSeoPage[] = [
  ...
  // warnings the JA/KO siblings already produce).
  {
    ...
    meta_description:
      "按等级比较曼谷各高尔夫球场的果岭费——从2,000泰铢以下的平价球场，到一价全包的高级套餐。看清你实际要付多少钱。",
    featured_image: null,
    schema_markup: null,
    status: "published",
    category: "costs",
    ...
    content: {
      ...
      sections: [
        ...
        },
        {
          ...
          body: "การให้ทิปแคดดี้เป็นธรรมเนียมปฏิบัติปกติที่ควรทำ อัตราทั่วไปอยู่ที่ 400-500 บาทต่อรอบ (ข้อมูล ณ กรกฎาคม 2026) จ่ายเป็นเงินสดให้แคดดี้โดยตรง หากได้แคดดี้ที่ช่วยเหลือดีเป็นพิเศษหรือมีฝีมือ การให้ทิป 600-1,000 บาทก็ถือว่าเหมาะสม\n\nควรเตรียมเงินสดให้พร้อมก่อนกลับถึงคลับเฮาส์ แล้วยื่นให้แคดดี้โดยตรงพร้อมกล่าวขอบคุณสั้น ๆ",
        },
        {
          heading: "หลังจบรอบ",
