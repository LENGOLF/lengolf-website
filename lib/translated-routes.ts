...
> = {
  th: {
    staticRoutes: [
      ...
      // 0/12 -> 12/12. Inserted here rather than appended so the paths stay
      // alphabetical within the array; the batch-9 bangkok comment below is
      // NOT the header for these twelve.
