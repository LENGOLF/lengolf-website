...
export default function MobileStickyBar() {
  ...
  const ctaClass =
    'flex h-11 w-full items-center justify-center gap-2 rounded-lg bg-primary text-sm font-semibold text-white transition-colors hover:bg-primary/90'
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-30 border-t border-primary/20 bg-white/95 backdrop-blur-sm px-4 py-2.5 md:hidden">
      {isCourseContext ? (
        ...
        <a href={BOOKING_URL} target="_blank" rel="noopener noreferrer" className={ctaClass}>
