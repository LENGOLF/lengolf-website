...
- **`build-and-smoke`** — builds the app, starts the production server, runs smoke tests across 14 categories (per-category test counts live in `scripts/smoke-test.ts`):
