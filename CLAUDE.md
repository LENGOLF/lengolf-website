...
- **`build-and-smoke`** — builds the app, starts the production server, runs smoke tests across 17 categories (per-category test counts live in `scripts/smoke-test.ts`):
